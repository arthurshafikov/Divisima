	      ...
	      <tr>
            ...
            @foreach ($order->products as $product)
              <tr style="border-bottom: 1px solid rgba(0,0,0,.05);">
                ...
                <td valign="middle" width="30%" style="text-align:left; padding: 0 0.5em;">
                  <span class="price" style="color: #000; font-size: 16px;">{{$product->formatted_subtotal}}</span>
                </td>
              </tr>
            @endforeach
                ...
                <p><b>Index</b> {{ $order->zip }}</p>
                <p><b>Phone</b> {{ $order->phone }}</p>
                <p><b>Additional</b> {{ $order->additional }}</p>
                <p><b>Total</b> {{ $order->formatted_total }}</p>
					  	</td>
					  </tr>
	      	</table>
	      </tr><!-- end tr -->
