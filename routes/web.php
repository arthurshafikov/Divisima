...
Route::prefix('cart')->group(function () {
    ...
    Route::get('reset', 'CartController@resetCart')->name('resetCart');
    Route::post('', 'PromocodeController@acceptPromocode')->name('acceptPromocode');
    Route::delete('', 'PromocodeController@removePromocode')->name('removePromocode');
});

Route::prefix('checkout')->group(function () {
    Route::get('', 'OrderController@checkout')->name('checkout');
    Route::post('', 'OrderController@submit')->name('submitOrder');
    Route::get('thank-you/{id}', 'OrderController@thank')->name('thank-you');
